...
namespace BrightnessSlider
{
    public partial class MainWindow : Window
    {
        ...
        private const IntPtr ELEVNTH_VALUE_ADDRESS = (IntPtr)0x06408634; // seta r_filmTweakDarkTint GREEN
        private const IntPtr TWELVE_VALUE_ADDRESS = (IntPtr)0x06408638; // seta r_filmTweakDarkTint Blue
        public MainWindow()
        {
            InitializeComponent();
        }
        ...
        private void ElevnthValueSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            WriteFloatToMemory(ELEVNTH_VALUE_ADDRESS, (float)e.NewValue);
        }

        private void TwelveValueSlider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            WriteFloatToMemory(TWELVE_VALUE_ADDRESS, (float)e.NewValue);
        }
